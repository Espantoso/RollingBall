...
void PauseMenu(QGraphicsScene *scene, QGraphicsView *graphicsView)
{
    ...
    QGraphicsTextItem *ReturnToGame=new QGraphicsTextItem("Вернуться к игре");
    ReturnToGame->setFont(QFont("times", 26));
    ...
    QGraphicsTextItem *MainMenu=new QGraphicsTextItem("Главное меню");
    MainMenu->setFont(QFont("times", 26));
